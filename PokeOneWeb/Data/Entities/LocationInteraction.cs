...
namespace PokeOneWeb.Data.Entities
{
    ...
    /// a feature of an in-game <see cref="Entities.Location"/> which a Player can interact with.
    ...
    /// 
    /// In order to ensure conflicting column names always explicitly specify names for any additional columns
    ...
    public abstract class LocationInteraction
    {
        ...
        /// <summary>
        /// The in-game X-coordinate of the location. For interactions that are larger than one tile choose the middlemost coordinate.
        /// </summary>
        public int X { get; set; }

        /// <summary>
        /// The in-game Y-coordinate of the location. For interactions that are larger than one tile choose the middlemost coordinate.
        /// </summary>
